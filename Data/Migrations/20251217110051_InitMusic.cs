    ...
    public partial class InitMusic : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    SongId = table.Column<int>(type: "int", nullable: false),
                    LyricsExcerpt = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    RecordingDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RecordingStudio = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Bitrate = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SongDetails", x => x.SongId);
                    table.ForeignKey(
                        name: "FK_SongDetails_Songs_SongId",
                        column: x => x.SongId,
                        principalTable: "Songs",
                        principalColumn: "SongId",
                        onDelete: ReferentialAction.Cascade);
