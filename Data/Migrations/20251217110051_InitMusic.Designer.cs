...
namespace MusicLibrary.Data.Migrations
{
    ...
    [Migration("20251217110051_InitMusic")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicDatabase.Models.Album", b =>
                {
            ...
            modelBuilder.Entity("MusicDatabase.Models.SongDetails", b =>
                {
                    b.Property<int>("SongId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("LyricsExcerpt")
                        .HasMaxLength(200)
                    ...
                    b.Property<string>("RecordingStudio")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("ArtistSong", b =>
                {
                    b.HasOne("MusicDatabase.Models.Artist", null)
                        .WithMany()
                        .HasForeignKey("ArtistsArtistId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MusicDatabase.Models.Song", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MusicDatabase.Models.Song", b =>
                {
                    b.HasOne("MusicDatabase.Models.Album", "Album")
                        .WithMany("Songs")
            ...
            modelBuilder.Entity("MusicDatabase.Models.SongDetails", b =>
                {
                    b.HasOne("MusicDatabase.Models.Song", "Song")
                        .WithOne("Details")
                        .HasForeignKey("MusicDatabase.Models.SongDetails", "SongId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
